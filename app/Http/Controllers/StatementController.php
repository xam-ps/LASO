...
class StatementController extends Controller
{
    public function index(Request $request)
    {
        ...
        $costsByCostType = Expense::join('cost_types', 'expenses.cost_type_id', '=', 'cost_types.id')
            ...
            ->select('cost_types.elster_id', 'cost_types.full_name', DB::raw('SUM(expenses.net) * cost_types.ratio as total_cost'), DB::raw('SUM(expenses.tax) * cost_types.ratio as total_tax'))
        ...
        $expNetSum = $costsByCostType->sum('total_cost') - $expensesWithTypeAfa;
