...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::prefix('statement')->name('statement.')->group(function () {
        ...
        Route::get('/{year}', [StatementController::class, 'index'])->whereNumber('year')->name('year');
    });
    ...
    Route::prefix('vat-notice')->name('vat-notice.')->group(function () {
        ...
        Route::get('/create/{year}', [VatNoticeController::class, 'create'])->whereNumber('year')->name('createYear');
        Route::get('/{year}', [VatNoticeController::class, 'index'])->whereNumber('year')->name('year');
    ...
    Route::prefix('travel-allowance')->name('travel-allowance.')->group(function () {
        ...
        Route::get('/all/{year}', [TravelAllowanceController::class, 'index'])->whereNumber('year')->name('year');
    ...
    Route::name('dashboard.')->group(function () {
        ...
        Route::get('/{year}', [DashboardController::class, 'index'])->whereNumber('year')->name('year');
    });
});
